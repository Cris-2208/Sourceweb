...
?>
<div class="">
        <h3 style="text-align: center">Member Registration</h3>
    <div style="padding: 0 28rem 0 37rem;">
			 	<form id="form1" name="form1" method="post" action="" class="form-horizontal" role="form">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10" style="text-align: end">
						      <input type="submit"  class="btn btn-success mb-4" name="btnRegister" id="btnRegister" value="Register"/>
